...
export default class AddTaskForm extends AbstractComponent { // Наследуемся от AbstractComponent
  get template() {
    return createAddTaskFormTemplate(); // Возвращаем шаблон через геттер template
  }
}
